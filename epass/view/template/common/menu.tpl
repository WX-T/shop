<ul id="menu">
  ...
  <!-- 商户管理 -->
  <li id="Merchant"><a class="parent"><i class="glyphicon glyphicon-user"></i> <span>商户管理</span></a>
  		<ul>
          <li><a href="<?php echo $merchant_list;?>">商户列表</a></li>
        </ul>
  </li>
  ...
  <li><a class="parent"><i class="fa fa-share-alt fa-fw"></i> <span><?php echo $text_marketing; ?></span></a>
    <ul>
      ...
      <li><a href="<?php echo $black_five; ?>">活动推荐</a></li>
    </ul>
  </li>
  ...
  <!-- 商品抓取 -->
  <li id="Grab"><a class="parent"><i class="glyphicon glyphicon-cloud-download"></i> <span>数据抓取</span></a>
  		<ul>
          <li><a href="<?php echo $grab_product_grab;?>">商品抓取</a></li>
          <li><a href="<?php echo $grab_product_list?>">已抓取列表</a></li>
        </ul>
  </li>
  
  <!-- 买手系统 -->
  <li id="buyer"><a class="parent"><i class="glyphicon glyphicon-tower"></i> <span>买手系统</span></a>
  		<ul>
          <li><a href="<?php echo $buyser_index;?>">买手管理</a></li>
          <li><a href="<?php echo $task_info ?>">任务列表</a></li>
        </ul>
  </li>
  
  <!-- 买手系统 -->
  <li id="buyer"><a class="parent"><i class="glyphicon glyphicon-tower"></i> <span>任务列表</span></a>
  		<ul>
          <li><a href="<?php echo $execute_task;?>">我的任务</a></li>
          <li><a href="<?php echo $buyser_amazon;?>">Amazon账号</a></li>
        </ul>
  </li>
