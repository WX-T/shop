...
class ControllerSettingSetting extends Controller {
	...
	public function index() {
		...
		if (isset($this->request->post['config_qq'])) {
		    $data['config_qq'] = $this->request->post['config_qq'];
		} else {
		    $data['config_qq'] = $this->config->get('config_qq');
		}
            
		if (isset($this->request->post['config_tel'])) {
		    $data['config_tel'] = $this->request->post['config_tel'];
		} else {
		    $data['config_tel'] = $this->config->get('config_tel');
		}
		...
		if (isset($this->request->post['config_order_submitted'])) {
		    $data['config_order_submitted'] = $this->request->post['config_order_submitted'];
		} else {
		    $data['config_order_submitted'] = $this->config->get('config_order_submitted');
		}
		
		if (isset($this->request->post['config_order_cancel'])) {
		    $data['config_order_cancel'] = $this->request->post['config_order_cancel'];
		} else {
		    $data['config_order_cancel'] = $this->config->get('config_order_cancel');
		}
