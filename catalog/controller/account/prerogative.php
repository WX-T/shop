<?php
	class ControllerAccountPrerogative extends Controller {
		public function index() {
			$this->load->model('account/customer');
			$this->document->setTitle('特权详情');
			...
			$this->response->setOutput($this->load->view('shopyfashion/template/account/prerogative.tpl', $data));
		}
