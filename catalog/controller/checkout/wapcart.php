<?php
class ControllerCheckoutWapcart extends Controller {
	public function index() {
		...
		if ($this->cart->hasProducts() || !empty($this->session->data['vouchers'])) {
			...
			foreach ($products as $product) {
				...
				$product_tariff = $product['hscode'] ? $this->currency->format($product_tariff).$this->tariff->getTariffSuff($order_tariff) : '';
				$data['products'][] = array(
	...
	public function add() {
		...
		if ($product_info) {
			...
			if (!$json) {
				...
				$json['success'] = sprintf($this->language->get('text_success'),$this->cart->countProducts() ,$this->currency->format($this->cart->getTotal()) , $this->url->link('checkout/cart'));
