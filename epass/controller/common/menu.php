...
class ControllerCommonMenu extends Controller {
	public function index() {
		...
		//商品抓取
		$data['grab_product_grab'] = $this->url->link('goods/capture', 'token=' . $this->session->data['token'], 'SSL');
		//以抓取列表
		$data['grab_product_list'] = $this->url->link('goods/capturelist', 'token=' . $this->session->data['token'], 'SSL');
		//商户列表
		$data['merchant_list'] = $this->url->link('user/merchant/index', 'token=' . $this->session->data['token'], 'SSL');
		//黑五活动
		$data['black_five'] = $this->url->link('marketing/blackfive/index','token=' . $this->session->data['token'], 'SSL');
		
		//买手系统
		$data['buyser_index'] = $this->url->link('extension/buyser/index','token=' . $this->session->data['token'], 'SSL');
		//买手任务列表
		$data['task_info'] = $this->url->link('extension/taskinfo/index','token=' . $this->session->data['token'], 'SSL');
		//任务执行
		$data['execute_task'] = $this->url->link('extension/executetask/index','token=' . $this->session->data['token'], 'SSL');
		//买手Amazon账号列表
		$data['buyser_amazon'] = $this->url->link('extension/executetask/buyamazon','token=' . $this->session->data['token'], 'SSL');
