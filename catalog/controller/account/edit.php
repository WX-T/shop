...
class ControllerAccountEdit extends Controller {
	...
	public function index() {
		...
		if(isset($this->session->data['success'])){
			$data['tip_success'] = $this->session->data['success'];
		...
		$this->load->model('account/customer');
		$coutomers = $this->model_account_customer->getCustomer($this->session->data['customer_id']);
		$data['fullname'] = $coutomers['fullname'];
		$data['headphoto'] = $coutomers['headphoto'];
