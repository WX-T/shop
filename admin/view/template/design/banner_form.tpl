          ...
          <table id="images" class="table table-striped table-bordered table-hover">
            <thead>
              <tr>
                ...
                <?php if($name == '立享优惠'|| $name=='时尚新品'): ?>
                <?php endif; ?>
                <td class="text-left"><?php echo $entry_link; ?></td>
                <td class="text-left"><?php echo $entry_image; ?></td>
                <!-- <td class="text_left"><?php echo $image_size; ?></td> -->
                <td class="text-right"><?php echo $entry_sort_order; ?></td>
                <?php if($name=='立享优惠'): ?>
                <?php elseif($name=='时尚新品'): ?>
                <?php else: ?>
                  <td></td>
                <?php endif; ?>
              </tr>
            ...
            <tbody>
              ...
              <tr id="image-row<?php echo $image_row; ?>">
                ...
                <!--设置图片大小-->
                <!-- <td>
                  <input class="form-control" type="text" style="width:110px; margin: auto;" placeholder="图片宽" value="<?php echo $banner_image['width']==0 ? '':$banner_image['width'] ?>" name="banner_image[<?php echo $image_row; ?>][img-width]"><br>
                  <input class="form-control" type="text" style="width:110px; margin: auto;" placeholder="图片高" value="<?php echo $banner_image['height']==0 ? '':$banner_image['height'] ?>" name="banner_image[<?php echo $image_row; ?>][img-height]">
                </td> -->
            ...
            <?php if($name=='立享优惠'): ?>
                 <script>
                if($('#image-row0').length<=0){
                  $('#images').append('<tr><td colspan="4"></td><td class="text-left"><button type="button" onclick="addImage();" data-toggle="tooltip" title="<?php echo $button_banner_add; ?>" class="btn btn-primary"><i class="fa fa-plus-circle"></i></button></td></tr>');
                }
              </script>
            <?php elseif($name=='时尚新品'): ?>
              <script>
