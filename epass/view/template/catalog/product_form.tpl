...
<div id="content">
        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-product" class="form-horizontal">
          ...
          <div class="tab-content">
              ...
              <div class="tab-content">
                ...
                <div class="tab-pane" id="language<?php echo $language['language_id']; ?>">
                  ...
                  <!-- <div class="form-group">
                    <label class="col-sm-2 control-label" for="input-name<?php echo $language['language_id']; ?>">商品详情页地址</label>
                    <div class="col-sm-10">
                      <input type="text"  placeholder="商品详情页地址" id="party_detail_url" class="form-control" />
                      <?php if (isset($error_name[$language['language_id']])) { ?>
                      <div class="text-danger"><?php echo $error_name[$language['language_id']]; ?></div>
                      <?php } ?>
                    </div>
            ...
            <div class="tab-pane" id="tab-data">
             <!-- 商户 -->       
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-merchant"><span data-toggle="tooltip" title="商户">商户</span></label>
                <div class="col-sm-10">
                  <select name="merchant_id" id="input-merchant" class="form-control">
                  	<?php foreach($merchants as $mer){?>
						<option <?php echo $mer['merchant_id']== $merchant_id ? 'selected="selected"':''?> value="<?php echo $mer['merchant_id']?>" ><?php echo $mer['merchant_name']?></option>
					<?php }?>
                  </select>
                </div>
              </div>
 			 ...
 			 <div class="form-group">
                <label class="col-sm-2 control-label" for="input-stock-status"><span data-toggle="tooltip" title="国家">国家</span></label>
                <div class="col-sm-10">
                  <select name="source" id="input-source" class="form-control">
                  </select>
                   <?php if ($error_source) { ?>
     		 ...
     		 <!-- 模式 -->  
              <div class="form-group">
                <label class="col-sm-2 control-label"><span data-toggle="tooltip" title="模式">模式</span></label>
                <div class="col-sm-10">
                  	<select name="bonded" id="input-model" class="form-control">
                  	<option>--请选择模式--</option>
                  	<?php foreach($bondedList as $bon){?>
                  		<option <?php echo $bon['model_id']==$bonded ? 'selected="selected"' :''?>  value="<?php echo $bon['model_id']?>" ><?php echo $bon['model_name']?></option>
                  	<?php }?>
                  	</select>
                </div>
              </div>
               ...
               <div class="form-group">
                <label class="col-sm-2 control-label" for="input-stock-status"><span data-toggle="tooltip" title="线路">线路</span></label>
                <div class="col-sm-10">
                  <select name="line_select_id" id="input-line" class="form-control">
                  </select>
                   <?php if ($error_line) { ?>
                  <div class="text-danger"><?php echo $error_line; ?></div>
                  <?php } ?> 
                </div>
              </div>
              <div class="form-group">
           ...
           <!-- 来源 -->   
                <!--  <input type="hidden" name="source" value="<?php echo $source; ?>" placeholder="<?php echo $entry_source; ?>" id="input-source" class="form-control" />
               -->
              
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-outurl"><?php echo $entry_outurl; ?></label>
                <div class="col-sm-10">
                  <input type="text" name="out_url" value="<?php echo $out_url; ?>" placeholder="<?php echo $entry_outurl; ?>" id="input-outurl" class="form-control" />
                </div>
              </div>
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-price"><?php echo $entry_list_price; ?></label>
                <div class="col-sm-10">
                  <input type="text" name="list_price" value="<?php echo $list_price; ?>" placeholder="<?php echo $entry_list_price; ?>" id="input-list_price" class="form-control" />
                </div>
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <input type="text" name="max" value="<?php echo $max; ?>" placeholder="<?php echo $entry_max; ?>" id="input-max" class="form-control" />
                </div>
              </div>
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-hscode">Hscode</label>
                <div class="col-sm-10">
                  <input type="text" name="hscode" value="<?php echo $hscode; ?>" placeholder="Hscode" id="input-sort-order" class="form-control" />
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-taxrate">税率（小数）</label>
                <div class="col-sm-10">
                  <input type="text" name="taxrate" value="<?php echo $taxrate; ?>" placeholder="税率（小数）" id="input-sort-order" class="form-control" />
                </div>
              </div>
            </div>
                    ...
                    <div class="tab-pane" id="tab-option<?php echo $option_row; ?>">
                      ...
                      <div class="table-responsive">
                        <table id="option-value<?php echo $option_row; ?>" class="table table-striped table-bordered table-hover">
                          ...
                          <tbody>
                            ...
                            <tr id="option-value-row<?php echo $option_value_row; ?>">
                              <td class="text-left"><select name="product_option[<?php echo $option_row; ?>][product_option_value][<?php echo $option_value_row; ?>][option_value_id]" class="form-control">
                                ...
                                <?php if($product_option['type'] == 'image'){?>
                                <td class="text-center"><a href="" id="thumb-image-<?php echo $option_row; ?>-<?php echo $option_value_row; ?>" data-toggle="image" class="img-thumbnail"><img src="<?php echo $product_option_value['thumb_image']; ?>" alt="" title="" data-placeholder="<?php echo $product_option_value['thumb_image']; ?>" style="width:50px;height:50px;"/></a>
                                <input id="input-image-<?php echo $option_row; ?>-<?php echo $option_value_row; ?>" type="hidden" name="product_option[<?php echo $option_row; ?>][product_option_value][<?php echo $option_value_row; ?>][image]" value="<?php echo $product_option_value['image']; ?>"/>
                                </td>
                                <?php }?>
                          ...
                          <tfoot>
                            <tr>
                              <td colspan="<?php if($product_option['type'] == 'image'){?>7<?php }else{?>6<?php }?>"></td>
                              <td class="text-left"><button type="button" onclick="<?php if($product_option['type'] == 'image') { ?>addOptionValue('<?php echo $option_row; ?>' , 1);<?php }else{ ?>addOptionValue('<?php echo $option_row; ?>' , 0);<?php }?>" data-toggle="tooltip" title="<?php echo $button_option_value_add; ?>" class="btn btn-primary"><i class="fa fa-plus-circle"></i></button></td>
                            </tr>
                          </tfoot>
                        </table>
                      </div>
              ...
              <div class="table-responsive">
                <table id="images" class="table table-striped table-bordered table-hover">
                  ...
                  <tbody>
                    ...
                    <?php $image_row++; ?>
                    <?php } ?>
                     <div id="uploader-demo2" class="wu-example">
                        <!--用来存放item-->
                       <div id="fileList" class="uploader-list"></div>
                        <div id="filePicker2">选择图片</div>
                        <?php foreach ($product_images as $key=>$product_image) { ?>
                        <div id="WU_FILE<?php echo $key?>" class="img-thumbnail upload-state-done">
                        	<img src="<?php echo $product_image['thumb']; ?>"><div class="info"><?php echo end(explode('/', $product_image['image']));?></div>
                        	<p class="list-group-item-success" style="text-align:center;">上传成功</p>
                        	<p class="list-group-item-danger active" image_src="<?php echo $product_image['image']?>" image_id="<?php echo $product_image['product_image_id'];?>" onclick="dbdelimg($(this))" style="text-align:center;">删除</p>
                        	<input id="input_WU_FILE<?php echo $key?>" name="product_image[<?php echo $key ?>on][image]" value="<?php echo $product_image['image']?>" type="hidden">
                        </div>
                        <?php } ?>
                    </div>
                  </tbody>
  ...
  <p id="select_line_id" val="<?php echo $line_select_id?>"></p>
  <p id="source_id" val="<?php echo $source?>"></p>
...
uploader2 = WebUploader.create({
    // 选完文件后，是否自动上传。
    auto: true,
    server: 'index.php?route=common/filemanager/uploadProductImg&token=<?php echo $token?>',
    // 选择文件的按钮。可选。
    // 内部根据当前运行是创建，可能是input元素，也可能是flash.
    pick: {'id':'#filePicker2'}, //只能选择一个图片
    // 只允许选择图片文件。
    accept: {
        title: 'Images',
        extensions: 'gif,jpg,jpeg,bmp,png',
...
uploader2.on( 'fileQueued', function( file ) {
	  var $li = $(
              '<div id="' + file.id + '_2" class="img-thumbnail">' +
                  '<img>' +
                  '<div class="info">' + file.name + '</div>' +
                  '<p class="list-group-item-warning" style="text-align:center;">等待上传</p>'+
                  '<p class="list-group-item-danger active" onclick="delqueue($(this))" style="text-align:center;">删除</p>'+
              '</div>'
              ),
          $img = $li.find('img');
      // $list为容器jQuery实例
      $("#uploader-demo2").append( $li );
      // thumbnailWidth x thumbnailHeight 为 100 x 100
...
uploader2.on( 'uploadSuccess', function( file,data ) {
  ...
  //判断是否真的上传成功
  if(data.code=='1'){
	  $( '#'+file.id+'_2' ).find('p').remove();
	  $( '#'+file.id+'_2' ).append('<p class="list-group-item-success" style="text-align:center;">上传成功</p>');
	  $( '#'+file.id+'_2' ).append('<input id="input_'+file.id+'" name="product_image['+file.id+'][image]" value="'+data.success+'" type="hidden">');
	  $( '#'+file.id+'_2').append('<p class="list-group-item-danger active" onclick="dbdelimg($(this))" style="text-align:center;">删除</p>');
 }else{
	  $( '#'+file.id+'_2' ).find('p').remove();
	  $( '#'+file.id+'_2' ).append('<p class="list-group-item-danger" style="text-align:center;">上传失败</p>');
  }
});
// 文件上传失败，显示上传出错。
...
//删除商品图片数据库图片
function dbdelimg(tthis){
	tthis.parent().remove();
}

//删除队列商品图片数据
function delqueue(tthis){
	 var id = tthis.parent().attr("id");
...
$('input[name=\'option\']').autocomplete({
	...
	'select': function(item) {
		...
		if (item['type'] == 'select' || item['type'] == 'radio' || item['type'] == 'checkbox' || item['type'] == 'image') {
			...
			if(item['type'] == 'image'){
				html += '        <td class="text-center">图片</td>';
			}
			...
			if(item['type'] == 'image'){
				html += '        <td class="text-left"><button type="button" onclick="addOptionValue(' + option_row + ' , 1);" data-toggle="tooltip" title="<?php echo $button_option_value_add; ?>" class="btn btn-primary"><i class="fa fa-plus-circle"></i></button></td>';
			}else{
				html += '        <td class="text-left"><button type="button" onclick="addOptionValue(' + option_row + ' , 0);" data-toggle="tooltip" title="<?php echo $button_option_value_add; ?>" class="btn btn-primary"><i class="fa fa-plus-circle"></i></button></td>';
			}
			html += '      </tr>';
			html += '    </tfoot>';
			html += '  </table>';
...
function addOptionValue(option_row , type) {	
	...
	if(type == 1){
		html += '  <td class="text-center"><a href="" id="thumb-image-' + option_row + '-' + option_value_row + '" data-toggle="image" class="img-thumbnail"><img src="<?php echo $placeholder; ?>" alt="" title="" data-placeholder="<?php echo $placeholder; ?>"  style="width:50px;height:50px;"/></a><input id="input-image-' + option_row + '-' + option_value_row + '" type="hidden" name="product_option[' + option_row + '][product_option_value][' + option_value_row + '][image]" value=""/></td>'; 
	}
...
function ajaxAddOption(item){
	...
	if (item.type == 'select' || item['type'] == 'radio' || item['type'] == 'checkbox' || item['type'] == 'image') {
        ...
        for (var i = 0; i < item.values.length; i++) {
			html += '  <option value="' + item.values[i].id + '">' + item.values[i].name+ '</option>';
        }
        html += '  </select>';	
		html += '</div>';	
	}
	$('#tab-option .tab-content').append(html);
	$('#option > li:last-child').before('<li><a href="#tab-option' + option_row + '" data-toggle="tab"><i class="fa fa-minus-circle" onclick="$(\'a[href=\\\'#tab-option' + option_row + '\\\']\').parent().remove(); $(\'#tab-option' + option_row + '\').remove(); $(\'#option a:first\').tab(\'show\')"></i> ' + item.name + '</li>');
	$('#option a[href=\'#tab-option' + option_row + '\']').tab('show');
	$('.date').datetimepicker({
		pickTime: false
	});
	...
	if(item.type == 'image'){
		ajaxAddOptionValue(option_row , 1 , item.values);
	}else{
		ajaxAddOptionValue(option_row , 0 , item.values);
	}
	option_row++;
}

function ajaxAddOptionValue(option_row , type , values) {
	for (var i = 0; i < values.length; i++) {
		...
		html += '  </select><input type="hidden" name="product_option[' + option_row + '][product_option_value][' + option_value_row + '][product_option_value_id]" value="" /></td>';
		if(type == 1){
			html += '  <td class="text-center"><a href="" id="thumb-image-' + option_row + '-' + option_value_row + '" data-toggle="image" class="img-thumbnail"><img src="'+values[i].thumb+'" alt="" title="" data-placeholder="values[i].thumb"  style="width:50px;height:50px;"/></a><input id="input-image-' + option_row + '-' + option_value_row + '" type="hidden" name="product_option[' + option_row + '][product_option_value][' + option_value_row + '][image]" value="'+values[i].img+'"/></td>'; 
		}
		html += '  <td class="text-right"><input type="text" name="product_option[' + option_row + '][product_option_value][' + option_value_row + '][quantity]" value="999" placeholder="<?php echo $entry_quantity; ?>" class="form-control" /></td>'; 
		html += '  <td class="text-left"><select name="product_option[' + option_row + '][product_option_value][' + option_value_row + '][subtract]" class="form-control">';
		html += '    <option value="1"><?php echo $text_yes; ?></option>';
		...
		$('#option-value' + option_row + ' tbody').append(html);
		$("select[name='product_option[" + option_row + "][product_option_value][" + option_value_row + "][option_value_id]']").val(values[i].id); 
	    $('[rel=tooltip]').tooltip();
		option_value_row++;
	}
}
...
function addSpecial(spec_price) {
	...
	html += '  <td class="text-right"><input type="text" name="product_special[' + special_row + '][price]" value="'+spec_price+'" placeholder="<?php echo $entry_price; ?>" class="form-control" /></td>';
...
$("#party_detail_url").on('blur' , function(){
	var url = $(this).val();
	if($.trim(url) != '' && url.indexOf('http') != '-1'){
		var loading = layer.msg('正在获取数据，请稍等...', {icon: 16 , shade: [0.1,'#000'],time: -1});
		$.ajax({
			type : 'post',
			url: 'index.php?route=catalog/product/ajax_getinfo&token=<?php echo $token; ?>',
			dataType: 'json',	
			data : {url : url},
			success: function(json) {
				layer.close(loading);
				if(json.title){
					$("input[name='product_description[1][name]']").val(json.title);
					$("input[name='model']").val(json.model);
					$("input[name='product_description[1][meta_title]']").val(json.title);
					$('#input-description<?php echo $language['language_id']; ?>').code(json.detail);
					$("input[name='quantity']").val(999);
					if(json.listprice){
						$("input[name='price']").val(json.listprice);
						addSpecial(json.price);
					}else{
						$("input[name='price']").val(json.price);
					}
					$("input[name='manufacturer']").val(json.brandName);
					$("input[name='manufacturer_id']").val(json.brandId);
					$("input[name='source']").val('nordstrom');
					$("input[name='out_url']").val(url);
					if(json.images.length>0){
						for(var i=0 ; i<json.images.length ; i++){
							if(i == 0 && $("#input-image").val() == ''){
								$("#thumb-image").children('img').attr('src' , json.images[i].thumb);
								$("#input-image").val(json.images[i].file_url);
							}else{
								var is_exist = false;
								$(".img-thumbnail").each(function(){
									var value = $(this).next('input').val();
									if(json.images[i].file_url == value){
										is_exist = true;
									}
								});
								if(!is_exist){
									addAjaxImage(json.images[i]);
								}
							}
						}
					}
					if(json.options.length>0){
						for(var i=0 ; i<json.options.length ; i++){
							ajaxAddOption(json.options[i]);
						}
					}
				}else{
					$("#party_detail_url").val('');
				}
			}
		});
	}else{
...
function addAjaxImage(imgurl) {
	html  = '<tr id="image-row' + image_row + '">';
	html += '  <td class="text-left"><a href="" id="thumb-image' + image_row + '"data-toggle="image" class="img-thumbnail"><img src="' + imgurl.thumb + '" alt="" title="" data-placeholder="' + imgurl.thumb + '" /><input type="hidden" name="product_image[' + image_row + '][image]" value="' + imgurl.file_url + '" id="input-image' + image_row + '" /></td>';
	html += '  <td class="text-right"><input type="text" name="product_image[' + image_row + '][sort_order]" placeholder="<?php echo $entry_sort_order; ?>" class="form-control" value="' + image_row + '"/></td>';
	html += '  <td class="text-left"><button type="button" onclick="$(\'#image-row' + image_row  + '\').remove();" data-toggle="tooltip" title="<?php echo $button_remove; ?>" class="btn btn-danger"><i class="fa fa-minus-circle"></i></button></td>';
	html += '</tr>';
...
//预加载
getCountry($("#input-merchant").val());
//获取国家
function getCountry(merchant_id){
	$("#input-source").html('');
	$("#input-line").html('');
	if(merchant_id){
		$.ajax({
     	    type: 'GET',
     	    url: "index.php?route=catalog/product/getMerchantCountry&token=<?php echo $token?>&merchant_id="+merchant_id,
     	    dataType:'Json',
     	    success: function(data){
     	    	for(var i=0;i<data.length;i++){
         	    	if('<?php echo $source?>' == data[i]['country_id']){
         	    		var html = '<option selected="selected" value="'+data[i]['country_id']+'">'+data[i]['country_name']+'</option>'
             	    }else{
             	    	var html = '<option value="'+data[i]['country_id']+'">'+data[i]['country_name']+'</option>'
                 	}
					$("#input-source").append(html);
					
         	    }
     	    	getLines($("#input-source").val(),$("#input-merchant").val());
        	}
     	});
	}
}
...
$("#input-model").change(function(){
	//保税商品无线路
	if($('#input-model option:selected').val() == 1){
		$("#input-line").html('');
		$("#input-line").append('<option>--保税无线路--</option>');
	}else{
		getLines($('#input-source option:selected').val(),$("#input-merchant").val());
	}
});
...
//获取商户线路
function getLines(country_id,merchant_id){
	$("#input-line").html('');
	if($('#input-model option:selected').val() == 1){
		$("#input-line").append('<option>--保税无线路--</option>');
	}else{
		if(country_id){
			$.ajax({
	     	    type: 'GET',
	     	    url: "index.php?route=catalog/product/getMerchantLines&token=<?php echo $token?>&country_id="+country_id+'&merchant_id='+merchant_id,
	     	    dataType:'Json',
	     	    success: function(data){
	         	    if(data){
	             	    console.log(data);
						for(var i=0;i<data.length;i++){
							if('<?php echo $line_select_id?>'== data[i]['line_id']){
								var html = '<option selected="selected" value="'+data[i]['line_id']+'">'+data[i]['title']+'</option>';
							}else{
								var html = '<option value="'+data[i]['line_id']+'">'+data[i]['title']+'</option>'
							}
							$("#input-line").append(html);
						}
...
$("#input-merchant").change(function(){
	getCountry($(this).val());
});
