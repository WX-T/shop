...
class ControllerModuleLatest extends Controller {
	...
	public function index() {
		...
		if(isset($this->request->get['module_id'])){
    		$resoule = $this->model_extension_module->getModule($this->request->get['module_id']);
    		if(isset($resoule['product'])){
        		foreach ($resoule as $product_id) {
		...
		} elseif (isset($module_info['product'])) {
