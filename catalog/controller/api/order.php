...
class ControllerApiOrder extends Controller {
		...
		if (!isset($this->session->data['api_id'])) {
			...
			if ($order_info) {
				...
				if (!$json) {
					...
					$order_data['shipping_agents'] = $this->request->post['shipping_agents'];
					$order_data['assbillno'] = $this->request->post['assbillno'];
					$order_data['ship_price'] = $this->request->post['ship_price'];
					// Shipping Details
					if ($this->cart->hasShipping()) {
						$order_data['shipping_fullname'] = $this->session->data['shipping_address']['fullname'];
						$order_data['shipping_telephone'] = $this->session->data['shipping_address']['shipping_telephone'];
	...
	public function history() {
		...
		if (!isset($this->session->data['api_id'])) {
			...
			if ($order_info) {
			    if($this->request->post['shipping_agents']){
			        $this->model_checkout_order->shipment($order_id,$this->request->post['shipping_agents'],$this->request->post['assbillno'],$this->request->post['ship_price']);
			    }
