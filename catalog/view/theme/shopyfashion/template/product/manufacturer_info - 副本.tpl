...
<div class="panel-align global-search"></div>
<div class="content">
  <div class="panel-align sure-type ">
	  <?php if ($brands) { ?>
	  <div class="pinpai">
        ...
        <div class="right">
            <ul>
            	...
            	<li><a href="<?php echo $brand['href']; ?>"><em><?php echo $brand['name']; ?></em></a></li>
            	<?php } ?>
           </ul>
      	</div>
      </div>
      ...
      <?php } ?>  
      <?php if ($categories) { ?>
      <div class="pinpai type">
      	<div class="left">相关分类：</div>
      	<div class="right">
        	<ul>
                <?php foreach ($categories as $category) { ?>
            	   <li><a href="<?php echo $category['href']; ?>"><em><?php echo $category['name']; ?></em></a></li>
            	<?php } ?>
            </ul>
         </div>
      </div>
	...
	<!-- 排序 -->
     <div class=" panel-align sort-goods">
        ...
        <input type="hidden" value="<?php echo $manufacturer_id?>" name="manufacturer_id">
    ...
    <div class="list">
            ...
            <div class="title"><a href="<?php echo $product['href']; ?>"><?php echo $product['name']; ?></a></div>
            	<div class="detail">
            		<?php if ($product['price']) { ?>
	                  ...
	                  <?php } else { ?>
	                  <span class="jiaqian"><?php echo $product['special']; ?><br/>
	                  <span class="shuiqian">原价：<?php echo $product['price']; ?></span></span>
	                  <?php } ?>
	                <?php } ?>
                    <div class="fr top">
     ...
     <div class="row">
         <div class="text-left"><?php echo $pagination; ?><div class="text-result"><span><?php echo $results; ?></span></div></div>
     </div>
    </div>
</div>
