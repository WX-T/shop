...
class ControllerCatalogCategory extends Controller {
	...
	protected function getForm() {
		...
		//生成品牌url
		$data['manufacturerurl'] = $this->url->link('product/manufacturer/info','','SSL');
		...
		} elseif (!empty($category_info) && isset($category_info['recommend'])) {
		    $images = unserialize($category_info['recommend']);
		    $imageArr = array();
		    if($images){
