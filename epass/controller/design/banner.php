...
class ControllerDesignBanner extends Controller {
	...
	public function edit() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			//处理图片大小
			$data = $this->request->post['banner_image'];
	...
	protected function getForm() {
		...
		$data['image_size'] = '图片大小';
		$data['entry_sort_order'] = $this->language->get('entry_sort_order');
		$data['entry_describe']='描述';
		$data['describe_name'] = 'describe';
		...
		//&& isset($this->request->post['width']) && $this->request->post['height']
		...
		foreach ($banner_images as $banner_image) {
			...
			$data['banner_images'][] = array(
				...
				//'describe'			       => $banner_image['describe'],
			);
		}
