<?php
class ControllerProductWapmanufacturer extends Controller {
	public function index() {
		...
		foreach ($results as $result) {
			...
			$data['categories'][$key]['manufacturer'][] = array(
				'name' => $result['name'],
				'href' => $this->url->link('product/wapmanufacturer/info', 'manufacturer_id=' . $result['manufacturer_id']),
...
// 			$data['detailed'] = $manufacturer_info['detailed'];
			...
			foreach ($results as $result) {
				...
				$data['products'][] = array(
					...
					'href'        => $this->url->link('product/wapproduct', 'manufacturer_id=' . $result['manufacturer_id'] . '&product_id=' . $result['product_id'] . $url)
				);
			}
			$url = '';
