                ...
                <table id="images" class="table table-striped table-bordered table-hover">
                  ...
                  <tbody>
                    ...
                    <tr id="image-row<?php echo $image_row; ?>">
                       <td style="display:none" class="text-left"><a href="" id="thumb-image<?php echo $image_row; ?>" data-toggle="image" class="img-thumbnail"><img src="<?php echo $image['thumb']; ?>" alt="" title="" data-placeholder="<?php echo $placeholder; ?>" /></a><input type="hidden" name="images[<?php echo $image_row; ?>][image]" value="<?php echo $image['image']; ?>" id="input-image<?php echo $image_row; ?>" /></td>
                        <!-- <input type="text" name="images[<?php echo $image_row; ?>][title]" value="<?php if(isset($image[  'title'])){echo $image['title'];} ?>" placeholder="标题" class="form-control" /> -->
                      <!--分类推荐选择品牌名============================-->
                      <td class="text-right">
                         <input type="text" name="images[<?php echo $image_row; ?>][title]" value="<?php if(isset($image[  'title'])){echo $image['title'];} ?>" placeholder="标题" id="input-tag<?php echo $language['language_id']; ?>" class="form-control automanufacturer" />
                      </td>

                      <td style="display:none" class="text-right"><input type="hidden" name="images[<?php echo $image_row; ?>][url]" value="<?php if(isset($image['url'])){echo $image['url'];} ?>" placeholder="链接" class="form-control" /></td>
...
function getmanufacturerUrl(id){
    var url = "<?php echo $manufacturerurl ?>&manufacturer_id="+id;
    var reg = /admin\//;
...
function addImage() {
	...
	html += '  <td style="display:none" class="text-left"><a href="" id="thumb-image' + image_row + '"data-toggle="image" class="img-thumbnail"><img src="<?php echo $placeholder; ?>" alt="" title="" data-placeholder="<?php echo $placeholder; ?>" /><input type="hidden" name="images[' + image_row + '][image]" value="" id="input-image' + image_row + '" /></td>';

  html += '  <td class="text-right manufacturer"><input type="text" name="images[' + image_row + '][title]" value="" placeholder="标题" class="form-control automanufacturer" /></td>';


	html += '  <td style="display:none" class="text-right"><input type="hidden" name="images[' + image_row + '][url]" value="" placeholder="链接" class="form-control" /></td>';
...
//--></script> 
  ...
  $(document).on('focus' , '.automanufacturer'  ,function(){
       brandAutoComplete(this);
  });


function brandAutoComplete(obj){
    $(obj).autocomplete({
    ...
    'select': function(item) {
      $(this).val(item['label']);
      $(this).parent('.text-right').next().children().val(getmanufacturerUrl(item['value']));
      //$(this).val(getmanufacturerUrl(item['value']));
      //$(this).val(item['value']);
    } 
  });
}
