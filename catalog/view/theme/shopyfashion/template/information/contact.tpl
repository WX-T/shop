...
<?php echo $column_left; ?>
    <div class="content_contact"><?php echo $content_top; ?>
...
              <?php if($map_select == 'google') { ?>
			  <br/>
              <a href="https://maps.google.com/maps?q=<?php echo urlencode($geocode); ?>&hl=en&t=m&z=15" target="_blank" class="btn btn-primary"><i class="fa fa-map-marker"></i> <?php echo $button_map; ?></a>
              <?php }else{ ?>
				<br/>
               <a href="<?php echo $baidu_map ?>" target="_blank" class="btn btn-primary"><i class="fa fa-map-marker"></i> <?php echo $button_baidu_map; ?></a>
              <?php } ?>
              <?php } ?>
            </div>
