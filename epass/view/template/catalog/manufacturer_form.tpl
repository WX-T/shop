      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-manufacturer" class="form-horizontal">
          ...
          <div class="form-group">
            <label class="col-sm-2 control-label" for="input-sort-order">描述</label>
            <div class="col-sm-10">
              <input type="text" name="detailed" value="<?php echo $detailed; ?>" placeholder="输入描述信息" id="input-sort-order" class="form-control" />
            </div>
          </div>
