          ...
          <div class="tab-pane active" id="tab-order">
            <table class="table table-bordered">
              ...
              <tr>
                ...
                <td style="color:#ee4037"><?php echo $comment; ?></td>
              </tr>
              <?php } ?>
              <?php if ($affiliate) { ?>
              <tr>
            ...
            <fieldset>
              ...
              <form class="form-horizontal">
                <div class="form-group">
                 ...
                 <!-- 物流公司 -->
                <div class="form-group wuliu" style="display:none">
                  <label class="col-sm-2 control-label" for="input-notify">物流公司</label>
                  <div class="col-sm-10">
                    <input type="input" style="width:250px;" name="shipping_agents" value="<?php echo $shipping_agents;?>" id="shipping_agents" />
                  </div>
                </div>
                <!-- 物流号 -->
                 <div class="form-group wuliu" style="display:none">
                  <label class="col-sm-2 control-label" for="input-notify">物流号</label>
                  <div class="col-sm-10">
                    <input type="input" style="width: 250px;" name="logistics" value="<?php echo $logistics;?>" id="logistics" />
                  </div>
                 </div>
                <div class="form-group">
                ...
                <div class="form-group">
                 ...
                 <!-- 
                 <div class="form-group wuliu" style="display:none">
                  <label class="col-sm-2 control-label" for="input-notify">杩愯垂</label>
                  <div class="col-sm-10">
                    <input type="input" style="width: 250px;" name="ship_price" value="" id="ship_price" />
                  </div>
                 </div>  -->
              </form>
...
if($('select[name="order_status_id"]').val()==29){
	$('.wuliu').show();
}
...
$('#button-history').on('click', function() {
  if(typeof verifyStatusChange == 'function'){
	...
	$.ajax({
		...
		type: 'post',
		dataType: 'json',
		data: 'order_status_id=' + encodeURIComponent($('select[name=\'order_status_id\']').val()) + '&notify=' + ($('input[name=\'notify\']').prop('checked') ? 1 : 0) + '&append=' + ($('input[name=\'append\']').prop('checked') ? 1 : 0) + '&comment=' + encodeURIComponent($('textarea[name=\'comment\']').val()) + '&shipping_agents=' + $('input[name=\'shipping_agents\']').val() + '&logistics=' + $('input[name=\'logistics\']').val(),
		beforeSend: function() {
...
$('select[name="order_status_id"]').change(
		function(){
		changeStatus(); 
	},
		function (){
