        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-setting" class="form-horizontal">
          ...
          <div class="tab-content">
            <div class="tab-pane active" id="tab-general">
              ...
              <!-- 客服QQ -->
              <div class="form-group required">
                <label class="col-sm-2 control-label" for="input-email">客服QQ</label>
                <div class="col-sm-10">
                  <input type="text" maxlength="15" name="config_qq" value="<?php echo $config_qq; ?>" placeholder="QQ号码" id="input-email" class="form-control" />
                </div>
              </div>
              <!-- 客服电话 -->
              <div class="form-group required">
                <label class="col-sm-2 control-label" for="input-email">客服电话</label>
                <div class="col-sm-10">
                  <input type="text" maxlength="15" name="config_tel" value="<?php echo $config_tel; ?>" placeholder="电话" id="input-email" class="form-control" />
                </div>
              </div>
              <div class="form-group required">
            ...
            <div class="tab-pane" id="tab-option">
              ...
              <fieldset>
                ...
                <div class="form-group">
                  <label class="col-sm-2 control-label" for="input-order-submitted"><span data-toggle="tooltip" title="订单提交状态">订单提交状态</span></label>
                  <div class="col-sm-10">
                    <select name="config_order_submitted" id="input-order-submitted" class="form-control">
                      <?php foreach ($order_statuses as $order_status) { ?>
                      <?php if ($order_status['order_status_id'] == $config_order_submitted) { ?>
                      <option value="<?php echo $order_status['order_status_id']; ?>" selected="selected"><?php echo $order_status['name']; ?></option>
                      <?php } else { ?>
                      <option value="<?php echo $order_status['order_status_id']; ?>"><?php echo $order_status['name']; ?></option>
                      <?php } ?>
                ...
                <div class="form-group">
                  <label class="col-sm-2 control-label" for="input-order-cancel"><span data-toggle="tooltip" title="订单取消状态">订单取消状态</span></label>
                  <div class="col-sm-10">
                    <select name="config_order_cancel" id="input-order-cancel" class="form-control">
                      <?php foreach ($order_statuses as $order_status) { ?>
                      <?php if ($order_status['order_status_id'] == $config_order_cancel) { ?>
                      <option value="<?php echo $order_status['order_status_id']; ?>" selected="selected"><?php echo $order_status['name']; ?></option>
                      <?php } else { ?>
                      <option value="<?php echo $order_status['order_status_id']; ?>"><?php echo $order_status['name']; ?></option>
                      <?php } ?>
            ...
            <div class="tab-pane" id="tab-image">
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-logo">二维码</label>
